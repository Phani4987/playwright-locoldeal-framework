...
- Name: auth.spec.js >> Authentication Consumer Api >> Consumer Login API
- Location: tests\auth.spec.js:28:5

# Error details

```
ReferenceError: Cannot access 'authApi' before initialization
```
