...
- Name: createcoupon.spec.js >> Coupon API - Create Online Business Coupon >> TC02 - Create Online affiliate Coupon Successfully
- Location: tests\createcoupon.spec.js:26:1
